...
import { FaHome, FaStore, FaShoppingCart, FaPlusCircle } from "react-icons/fa";
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <NavLink to="/productos" className="nav-link d-flex align-items-center gap-2">
                  Catálogo
                  <FaStore />
              </NavLink>
              </li>
              {usuario?.nombre === "admin" && (
                <li className="nav-item">
                  <NavLink to="/formulario-producto" className="nav-link d-flex align-items-center gap-2">
                    Agregar Producto
                    <FaPlusCircle />
                </NavLink>
                </li>
